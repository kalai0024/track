...
# 🔥 GET DATABASE URL
db_url = os.getenv("mysql://root:HxvupQVcALKwigmMSJHiRwlAYHgzsiml@interchange.proxy.rlwy.net:38833/railway")
 
# 👉 fallback for local testing (IMPORTANT)
if not db_url:
    db_url = "mysql://root:HxvupQVcALKwigmMSJHiRwlAYHgzsiml@interchange.proxy.rlwy.net:38833/railway"
